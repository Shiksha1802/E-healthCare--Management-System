		...
		<nav class="navbar navbar-expand-lg nav2">
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active"><a class="nav-link" href="DocProfileCtrl?user=<%=user%>">Profile </a></li>
					<li class="nav-item"><a class="nav-link" href="showAppointmentOnDoc">Appointment</a>
					</li>
					
                  <li class="nav-item">
                  <a class="nav-link" href="EHRCtrl">View EHR</a></li>
                  	<li class="nav-item">
